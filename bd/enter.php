  ...
  <html>
    ...
    <div class="enterno">
       ...
       include 'bd.php';
        ...
        {
        echo "Ви ввійшли на сайт як гість, Ви не зможете купляти білети";
        }
        else
        {
        echo "Ви ввійшли на сайт, як".$_SESSION['login'];
        }
        ?>
        <a href="http://192.168.0.109:8080/nonereg.html">Ок</a>
    </div>
    ...
    <p>
    <input class="btn_submit" type="submit" name="submit" value="Ввійти">
<br>
    <h4>Не зареєстрований?</h4>
    <button><a href="reg.php">Зареєструватися</a> 
    </p></form>
    <br>
